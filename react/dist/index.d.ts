...
declare function useAssistant_experimental({ api, threadId: threadIdParam, }: {
    api: string;
...
export { AssistantStatus, CreateMessage, Message, UseChatHelpers, UseChatOptions, UseCompletionHelpers, useAssistant_experimental, useChat, useCompletion };
